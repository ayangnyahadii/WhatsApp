let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    conn.reply(m.chat, `_Pesan terkirim kepemilik bot, jika ${command.toLowerCase()} hanya main-main tidak akan ditanggapi.\n\nNote:Jika Kami Mendeteksi Anda Mengirimkan Pesan Main Main Beberap kali Kami Bisa MEngambil Tindakan BANNED._`, m)
}
