...
async function connectionUpdate(update) {
  ...
  if (global.db.data == null) await loadDatabase()
    await conn.hehe("6285701399751@s.whatsapp.net", global.ftroli)
    await conn.hehe("120363041365929060@g.us", global.ftroli)
